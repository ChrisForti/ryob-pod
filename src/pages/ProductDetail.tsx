      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="aspect-square bg-gray-100 flex items-center justify-center">
                <div className="text-center text-gray-400 p-12">
                  ...
                  <p className="text-sm mt-2">
                    {boatName ? `"${boatName}" on Performance Long-Sleeve` : 'Add boat name to see preview'}
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="mb-4">
                <span className="text-sm text-gray-500 uppercase tracking-wide">Performance Apparel</span>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-green-600 mt-1">✓ In stock, ready to customize</p>
              </div>
            ...
            {/* Customizer Card */}
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Customize Your Gear</h3>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  maxLength={30}
                />
                <p className="text-xs text-gray-500 mt-1">{boatName.length}/30 characters</p>
              </div>
        ...
        <div className="mt-8 bg-white rounded-xl shadow-sm p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Material & Care</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
                  <span className="text-primary-600 mt-1">•</span>
